...
def http_get(url: str, temp_file: BinaryIO, proxies=None, resume_size=0, headers: Optional[Dict[str, str]] = None):
    ...
    # ML: manually edited, 20.10.2025

    if url.startswith('https://huggingface.cohttps://'):
        url = url[22:]
...
def get_from_cache(
    ...
    with FileLock(lock_path):
        ...
        with temp_file_manager() as temp_file:
            ...
            if 'https://huggingface.co' not in url_to_download:
                url_to_download = f'https://huggingface.co{url_to_download}'
